<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div>
            <x-input-label for="credential" :value="__('Enter your username/ phone /email ')" />
            <x-text-input id="credential" class="block mt-1 w-full" type="text" name="credential" :value="old('email')"
